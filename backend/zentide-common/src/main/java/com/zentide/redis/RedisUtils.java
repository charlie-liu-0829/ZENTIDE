...
public class RedisUtils<V> {
    ...
    public boolean set(String key, V value) {
        try {
            ...
            log.error("Redis value write failed; key and value were intentionally omitted", e);
            return false;
        }
    }
    ...
    public boolean setex(String key, V value, long time) {
        try {
            ...
            log.error("Redis value write with expiry failed; key and value were intentionally omitted", e);
            return false;
        }
    }
